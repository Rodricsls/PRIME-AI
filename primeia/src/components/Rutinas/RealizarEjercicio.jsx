...
export default function RealizarEjercicio(props) {
    ...
    async function finalizar() {
        ...
        try {
            ...
            const response = await axios.post('https://primeai.azurewebsites.net/FinishEjercicio', {id_rutina : id_rutina, id_ejercicio: id_ejercicio, dia : diaEjercicio, correo: correo }, { headers: { Authorization: `Bearer ${token}` } });
